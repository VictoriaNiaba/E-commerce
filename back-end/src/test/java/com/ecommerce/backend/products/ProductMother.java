...
import com.ecommerce.backend.products.model.Product.ProductBuilder;
...
public class ProductMother {
	...
	public ProductBuilder aBananaProduct() {
		String description = "This is a banana.";
		
		ProductBuilder banana = Product.builder()
				.id(autoIncrementId++)
				.title("Banana")
	...
	public ProductBuilder anAppleProduct() {
		String description = "This is an apple.";
		
		ProductBuilder apple = Product.builder()
				.id(autoIncrementId++)
				.title("Apple")
